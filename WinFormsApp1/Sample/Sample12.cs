        ...
        public static void Run()
        {
            ...
            for (int epoch = 0; epoch < 10; epoch++)
            {
                ...
                for (int i = 1; i < TRAIN_DATA_COUNT + 1; i++)
                {
                    ...
                    Debug.WriteLine("cDNI2 total loss " + cDNI2totalLoss / cDNI2totalLossCount);
                    Debug.WriteLine("cDNI3 total loss " + cDNI3totalLoss / cDNI3totalLossCount);

                    Debug.WriteLine("\ncDNI1 local loss " + cDNI1loss);
                    Debug.WriteLine("cDNI2 local loss " + cDNI2loss);
                    Debug.WriteLine("cDNI3 local loss " + cDNI3loss);
