        ...
        public static void Run()
        {
            ...
            for (int epoch = 0; epoch < 20; epoch++)
            {
                ...
                for (int i = 1; i < TRAIN_DATA_COUNT + 1; i++)
                {
                    ...
                    Debug.WriteLine("DNI2 total loss " + DNI2totalLoss / DNI2totalLossCount);
                    Debug.WriteLine("DNI3 total loss " + DNI3totalLoss / DNI3totalLossCount);

                    Debug.WriteLine("\nDNI1 local loss " + DNI1loss);
                    Debug.WriteLine("DNI2 local loss " + DNI2loss);
                    Debug.WriteLine("DNI3 local loss " + DNI3loss);
