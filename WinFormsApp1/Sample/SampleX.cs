...
namespace WinFormsApp1
{
    ...
    class SampleX
    {
        public static void Run()
        {
            ...
            Debug.WriteLine("\nl0 back");
            Debug.WriteLine(testInputValuesA.ToString("Grad"));

            Debug.WriteLine("\nl1-l4 sum back");
            Debug.WriteLine(testInputValuesB.ToString("Grad"));

            sgd.Update();
            sgdSplit.Update();

            Debug.WriteLine("\nl0 Weight");
            Debug.WriteLine(l0.Weight);

            Debug.WriteLine("\nl1 Weight");
            Debug.WriteLine(l1.Weight);

            Debug.WriteLine("\nl0 Bias");
            Debug.WriteLine(l0.Bias);

            Debug.WriteLine("\nl1 Bias");
            Debug.WriteLine(l1.Bias);
        }
    }
}
